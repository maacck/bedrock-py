/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 49ae9fde8d5382f2e4e3bf85be6dbacc)
// Runtime types generated with workerd@1.20260504.1 2026-05-07 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker");
		durableNamespaces: "RateLimiter" | "ThreadStore";
	}
	interface Env {
		AI: Ai;
		ASSETS: Fetcher;
		RATE_LIMITER: DurableObjectNamespace<import("./worker").RateLimiter>;
		THREAD_STORE: DurableObjectNamespace<import("./worker").ThreadStore>;
	}
}
